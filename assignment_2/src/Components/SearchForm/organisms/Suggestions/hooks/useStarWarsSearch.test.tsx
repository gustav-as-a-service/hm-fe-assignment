...
const useSearchMock: any = (search: string | undefined) => {
	return () => {
		return {search};
	};
};
	...
	describe("should handle undefined state: ", () => {
		...
		it("not emit triggering states searchResults, responseStatus", () => {
          ...
          <span data-testid="searchResults">{searchResults}</span>}
					{responseStatus && <span data-testid="responseStatus"></span>}
				</>);
			};
	...
	describe("should handle defined string: ", () => {
		...
		it("should handle API response", async () => {
			...
			const MockComponent = () => {
				...
				return (<>
					{searchResults &&
          <span data-testid="searchResults">{JSON.stringify(searchResults)}</span>}
					{responseStatus && <span data-testid="responseStatus"></span>}
				</>);
			};
